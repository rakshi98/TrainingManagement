          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Profile</span></a></li>
              ...
              <ul class="treeview-menu">
                <li><a href="scheduletraining.jsp">Schedule Training</a></li>
              ...
              <li><a href="feedback.jsp"><i class="fa fa-link"></i> <span>Feedback</span></a></li>
             <li><a href="viewfeedback.jsp"><i class="fa fa-link"></i> <span>ViewFeedback</span>
              <li><a href="viewnominations.jsp"><i class="fa fa-link"></i> <span>View Nomination</span></a></li>
...
<div class="form-group row">
<label for="trainingid" class="col-md-4 col-form-label text-md-right">trainingId</label>
<div class="col-md-6">
